...
namespace Knot.Runtime.Execution
{
    public class PlotPerformSys : MonoBehaviour
    {
        ...
        public static PlotPerformSys Instance
        {
            ...
            {
                if (_instance == null)
                    _instance = Component.FindAnyObjectByType<PlotPerformSys>();
                return _instance;
            }
        }
        ...
        {
            bool frameExecuteValid = FrameExecuteList.Contains(frameExecute);
            Dictionary<Type, KeyValuePair<InstrParam, InstrExecute>[]> exeTable
                = frameExecuteValid ? FrameExecuteList[index].ExeTable
                    : frameExecute.ExeTable;
            Debug.Log($"[PlotPerformSys.Execute]Executing {(frameExecuteValid ? index : " ")}...");
