...
namespace Knot.Instruction
{
    ...
    [Version("1.0.0")]
    [Serializable]
    public class IMAGParam: InstrParam
    {
        /// <summary>
        /// 指令名称
        /// </summary>
        public override string Name { get; protected set; } = nameof(IMAGParam);
        
        /// <summary>
        /// 执行器类型名称
        /// </summary>
        protected override string _ExecutorType { get; set; } = nameof(IMAG);

        /// <summary>
        /// 指令描述
        /// </summary>
        public override string Description { get; protected set; } = "IMAGParam Description";
    ...
    /// </summary>
    [Version("1.0.0")]
    public class IMAG: InstrExecute
    {
        /// <summary>
        /// 初始化逻辑
        /// </summary>
